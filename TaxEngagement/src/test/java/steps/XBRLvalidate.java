...
public class XBRLvalidate {
	...
	public void the_elements_of_the_XBRL_and_the_XLS_for_Specificatie_Deelneming_are_compared() throws Throwable {
		...
		// Naam deelneming
		Result.addAll(XMLandXLScompare.XMLandXLScheckerArrays("Spec_deelneming", "bd-bedr:ParticipatingInterestName", 1));
		...
		Result.addAll(
				XMLandXLScompare.XMLandXLScheckerArrays("Spec_deelneming", "bd-bedr:ParticipatingInterestBenefits", 12));
		...
		//Result.addAll(XMLandXLScompare.XMLandXLScheckerArrays("Spec_deelneming","bd-bedr:ParticipatingInterestAlienationAffiliatedPerson", 27));
		...
		//Result.addAll(XMLandXLScompare.XMLandXLScheckerArrays("Spec_deelneming","bd-bedr:ParticipatingInterestPercentageFallenBelowTwentyFivePercent", 36));
	...
	public void the_elements_of_the_XBRL_and_the_XLS_for_Balans_Activa_are_compared() throws Throwable {
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ShipName").toString(),
		...
		// Goodwill fiscaal
		// GoodwillFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:GoodwillFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 16, Tab)), "G17"));

		// Overige immateriële vaste activa fiscaal
		// IntangibleFixedAssetsOtherFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:IntangibleFixedAssetsOtherFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:IntangibleFixedAssetsTotalFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 18, Tab)), "G18"));

		// Gebouwen en terreinen fiscaal
		// BuildingsAndLandFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:BuildingsAndLandFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:FixedAssetsOtherFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:TangibleFixedAssetsFiscalTotal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 29, Tab)), "G29"));

		// Deelnemingen fiscaal
		// ParticipatingInterests
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ParticipatingInterests").toString(),
		...
		Result.addAll(
				vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:LongTermReceivablesGroupCompaniesFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:FinancialFixedAssetsOtherFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:FinancialFixedAssetsTotalFiscal").toString(),
		...
		Result.addAll(
				vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:LongTermReceivablesGroupCompaniesNominal").toString(),
		...
		Result.addAll(
				vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:FinancialFixedAssetsOtherTaxNominalFiscal").toString(),
						Double.parseDouble(BalansActivaXLS.HaalData("B", 40, Tab)), "B40"));

		// Voorraden, exclusief onderhanden werk
		// StockExcludingWorkInProgress
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:StockExcludingWorkInProgress").toString(),
		...
		// StockTotalFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:StockTotalFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:TradeAccountsReceivableFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 57, Tab)), "G57"));

		// Vorderingen omzetbelasting fiscaal
		// ValueAddedTaxReceivablesFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ValueAddedTaxReceivablesFiscal").toString(),
		...
		Result.addAll(
				vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ShortTermReceivablesGroupCompaniesFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ReceivablesOtherFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 61, Tab)), "G61"));

		// Totaal vorderingen fiscaal
		// ReceivablesTotalFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ReceivablesTotalFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 62, Tab)), "G62"));

		// Nominaal handelsdebiteuren fiscaal
		// TradeReceivablesNominal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:TradeReceivablesNominal").toString(),
		...
		Result.addAll(
				vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ShortTermReceivablesGroupCompaniesNominal").toString(),
		...
		// Effecten fiscaal
		// SecuritiesFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:SecuritiesFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 67, Tab)), "G67"));

		// Liquide middelen fiscaal
		// LiquidAssetsTotalFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:LiquidAssetsTotalFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 72, Tab)), "G72"));

		// Totaal activa fiscaal
		// AssetsTotalAmountFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:AssetsTotalAmountFiscal").toString(),
				Double.parseDouble(BalansActivaXLS.HaalData("G", 78, Tab)), "G78"));

		// Kosten aanschaf goodwill fiscaal
		// GoodwillPurchaseCostsFiscal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:GoodwillPurchaseCostsFiscal").toString(),
	...
	public void the_elements_of_the_XBRL_and_the_XLS_for_Balans_Passiva_are_compared() throws Throwable {
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ShipName").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("C", 13, Tab)), "C13"));

		// PaidCalledUpCapitalFiscal
		// Gestort en opgevraagd kapitaal fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:PaidCalledUpCapitalFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 9, Tab)), "F9"));

		// InformalCapitalFiscal
		// Informeel kapitaal fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:InformalCapitalFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 10, Tab)), "F10"));

		// SharePremiumFiscal
		// Agio fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:SharePremiumFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 11, Tab)), "F11"));

		// RetainedProfitsFiscal
		// Winstreserve fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:RetainedProfitsFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 12, Tab)), "F12"));

		// EqualizationReserveCostsFiscal
		// Kosten egalisatiereserve fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:EqualizationReserveCostsFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 13, Tab)), "F13"));

		// ReinvestmentReserveFiscal
		// Herinvesteringsreserve fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ReinvestmentReserveFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 14, Tab)), "F14"));

		// CompartmentReserveTaxed
		// Belaste compartimenteringsreserve
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:CompartmentReserveTaxed").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 15, Tab)), "F15"));

		// TaxReservesOtherFiscal
		// Overige fiscale reserves
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:TaxReservesOtherFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:WarrantyProvisionFiscal").toString(),
		...
		Result.addAll(
				vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ProvisionAnnuityPensionAndRightOfStanding").toString(),
						Double.parseDouble(BalansPassivaXLS.HaalData("F", 26, Tab)), "F26"));

		// ProvisionsOtherFiscal
		// Overige voorzieningen fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ProvisionsOtherFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 27, Tab)), "F27"));

		// ProvisionsTotalFiscal
		// Totaal voorzieningen fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ProvisionsTotalFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 28, Tab)), "F28"));

		// ConvertibleLoansFiscal
		// Converteerbare leningen fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ConvertibleLoansFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 36, Tab)), "F36"));

		// BondsFiscal
		// Obligaties fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:BondsFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:LongTermDebtsGroupCompanies").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:PayablesCreditInstitutionFiscal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 40, Tab)), "F40"));

		// LongTermDebtsOther
		// Overige langlopende schulden
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:LongTermDebtsOther").toString(),
		...
		Result.addAll(
				vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:AccountsPayableSuppliersTradeCreditors").toString(),
						Double.parseDouble(BalansPassivaXLS.HaalData("F", 49, Tab)), "F49"));

		// ValueAddedTaxPayablesFiscal
		// Schulden omzetbelasting fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ValueAddedTaxPayablesFiscal").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ShortTermDebtsGroupCompanies").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 52, Tab)), "F52"));

		// WageTaxDebt
		// Loonheffingen
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:WageTaxDebt").toString(),
		...
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:ShortTermDebtsTotal").toString(),
				Double.parseDouble(BalansPassivaXLS.HaalData("F", 55, Tab)), "F55"));

		// LiabilitiesTotalFiscal
		// Totaal passiva fiscaal
		Result.addAll(vergelijk.Vergelijk(ReadXML.GetXMLvalue("bd-bedr:LiabilitiesTotalFiscal").toString(),
	...
	public void the_elements_of_the_XBRL_and_the_XLS_for_Fiscale_vermogensvergelijking_are_compared() throws Throwable {
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:CorporationTaxWithdrawnFromEquityCapital").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:CapitalProvisionPaymentsNonDeductiblePart").toString(),
		...
		// Vermogensverschil
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:CapitalComparisonDifferenceOfCapitalTotal").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:CorporationTaxNonDeductibleAmountsTotal").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:BalanceProfitComparisonMethod").toString(), Double.parseDouble(FiscaleVermogensvergelijkingXLS.HaalData("F", 16, Tab)), "F16"));
	...
	public void the_elements_of_the_XBRL_and_the_XLS_for_Winst_en_verliesrekening_are_compared() throws Throwable {
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:StockAndWorkInProgressChangeFiscal").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:CapitalizedProductionOwnBusinessFiscal").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:BenefitsAndWageSubsidiesReceivedFiscal").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:IntangibleFixedAssetsOtherDepreciation").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:CompanyBuildingsDepreciationFiscal").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:MaintenanceOtherTangibleFixedAssetsFiscal").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:RevenuesOnReceivablesGroupCompanies").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:ReceivablesValuationChangeAmount").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:InterestExpenditureEtcCostsDebtsFiscal").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:CostsOnReceivablesGroupCompanies").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:BusinessFinanciaResultFiscalTotal").toString(),
		...
		Result.addAll(
				vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:ExtraordinaryIncomeBusinessOtherFiscal").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:ReinvestmentReservesWriteDownFiscal").toString(),
		...
		Result.addAll(vergelijk.VergelijkXBRL(ReadXML.GetXMLvalue("bd-bedr:ExtraordinaryBusinessResultsFiscal").toString(),
