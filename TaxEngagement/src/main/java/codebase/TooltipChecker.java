...
public class TooltipChecker extends AbstractSteps {
	...
	public static ArrayList<String> CheckTooltipVerliesVerrekening(String Naamobject, int Minlengte, int Maxlengte, String SoortValidatie, WebDriver driver) throws Exception {
		Actions action = new Actions(driver);
		TooltipResult.clear();
		Thread.sleep(600);
		// mous-over naar naamobject
		action.moveToElement(invoke(winstVerliesVerrekeningObjecten.class, Naamobject, driver)).build().perform();

		invoke(winstVerliesVerrekeningObjecten.class, Naamobject, driver).click();

		// checker
		checker.clear();
		checker = codebase.ValidatieChecker.CheckValue(invoke(winstVerliesVerrekeningObjecten.class, Naamobject, driver).getAttribute("value"), Minlengte, Maxlengte, SoortValidatie);
		if (!checker.isEmpty()) {
			try {
				WebElement elem = invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver);
				// Null indicates: expected tooltip text balloon is missing
				if (elem == null) {
					TooltipResult.add("Tooltip ontbreekt voor element " + Naamobject);
					System.out.println("Tooltip ontbreekt voor element:" + Naamobject);
					...
					if (checker.contains("BSN")) {
						if (!invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers")) {
							TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers \r\n");
						}
					}
					else {
						if (checker.contains("Te lang")) {
							if (!invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" + invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten \r\n");
							}

						}
						if (checker.contains("Geen positief getal")) {
							if (!invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[Negatief] Dit veld moet een positief getal bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Negatief] Dit veld moet een positief getal bevatten\" \r\n ");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Negatief] Dit veld moet een positief getal bevatten \r\n ");
						...
						if (checker.contains("Te Kort")) {
							if (!invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(winstVerliesVerrekeningTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten \r\n");
...
// **
	public static ArrayList<String> CheckTooltipInvesteringsRegeling(String Naamobject, int Minlengte, int Maxlengte, String SoortValidatie, WebDriver driver) throws Exception {
		Actions action = new Actions(driver);
		TooltipResult.clear();
		Thread.sleep(600);
		// mous-over naar naamobject
		action.moveToElement(invoke(InvesteringsaftrekObjecten.class, Naamobject, driver)).build().perform();

		invoke(InvesteringsaftrekObjecten.class, Naamobject, driver).click();
		...
		if (!checker.isEmpty()) {
			...
			try {
				...
				if (elem == null) {
					...
					if (checker.contains("BSN")) {
						if (!invoke(InvesteringsaftrekTooltipObjecten.class, Naamobject, driver).getText().contains("[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers")) {
							TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers \r\n");
						}
					}
					else {
						if (checker.contains("Te lang")) {
							if (!invoke(InvesteringsaftrekTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
						...
						if (checker.contains("Geen positief getal")) {
							if (!invoke(InvesteringsaftrekTooltipObjecten.class, Naamobject, driver).getText().contains("[Negatief] Dit veld moet een positief getal bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Negatief] Dit veld moet een positief getal bevatten\" \r\n ");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(InvesteringsaftrekTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Negatief] Dit veld moet een positief getal bevatten \r\n ");
						...
						if (checker.contains("Te Kort")) {
							if (!invoke(InvesteringsaftrekTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(InvesteringsaftrekTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten \r\n");
	...
	public static ArrayList<String> CheckTooltipZeeScheepvaart(String Naamobject, int Minlengte, int Maxlengte, String SoortValidatie, WebDriver driver) throws Exception {
		Actions action = new Actions(driver);
		TooltipResult.clear();
		Thread.sleep(600);
		// mous-over naar naamobject
		action.moveToElement(invoke(ZeescheepvaartObjecten.class, Naamobject, driver)).build().perform();

		invoke(ZeescheepvaartObjecten.class, Naamobject, driver).click();

		// checker
		checker.clear();
		checker = codebase.ValidatieChecker.CheckValue(invoke(ZeescheepvaartObjecten.class, Naamobject, driver).getAttribute("value"), Minlengte, Maxlengte, SoortValidatie);
		if (!checker.isEmpty()) {
			try {
				WebElement elem = invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver);
				// Null indicates: expected tooltip text balloon is missing
				if (elem == null) {
					TooltipResult.add("Tooltip ontbreekt voor element " + Naamobject);
					System.out.println("Tooltip ontbreekt voor element:" + Naamobject);
					...
					if (checker.contains("BSN")) {
						if (!invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText().contains("[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers")) {
							TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers \r\n");
						}
					}
					else {
						if (checker.contains("Te lang")) {
							if (!invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" + invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten \r\n");
							}
						...
						if (checker.contains("Geen positief getal")) {
							if (!invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText().contains("[Negatief] Dit veld moet een positief getal bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Negatief] Dit veld moet een positief getal bevatten\" \r\n ");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Negatief] Dit veld moet een positief getal bevatten \r\n ");
						...
						if (checker.contains("Te Kort")) {
							if (!invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten \r\n");
						...
						if (checker.contains("Positief10")) {
							if (!invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText().contains("Dit veld moet een positief getal bevatten tussen 0 en 9.999.999.999.")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: Dit veld moet een positief getal bevatten tussen 0 en 9.999.999.999.\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:Dit veld moet een positief getal bevatten tussen 0 en 9.999.999.999.\r\n");
							}
						}						

						if (checker.contains("Positief3")) {
							if (!invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText().contains("[Getal] Dit veld moet een positief getal bevatten tussen 0 een 999.")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: [Getal] Dit veld moet een positief getal bevatten tussen 0 een 999.\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Getal] Dit veld moet een positief getal bevatten tussen 0 een 999.\r\n");
							}
						}	
						
						if (checker.contains("Procent")) {
							if (!invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText().contains("[Percentage] Dit veld moet twee decimalen bevatten.")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was:[Percentage] Dit veld moet twee decimalen bevatten.\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(ZeeScheepvaartTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Percentage] Dit veld moet twee decimalen bevatten. \r\n");
							}
						}
					}
				}
	...
	public static ArrayList<String> CheckTooltipVerliesWinst(String Naamobject, int Minlengte, int Maxlengte, String SoortValidatie, WebDriver driver) throws Exception {
		Actions action = new Actions(driver);
		TooltipResult.clear();
		Thread.sleep(600);
		// mous-over naar naamobject
		action.moveToElement(invoke(WinstenVerliesRekeningObjecten.class, Naamobject, driver)).build().perform();

		invoke(WinstenVerliesRekeningObjecten.class, Naamobject, driver).click();

		// checker
		checker.clear();
		checker = codebase.ValidatieChecker.CheckValue(invoke(WinstenVerliesRekeningObjecten.class, Naamobject, driver).getAttribute("value"), Minlengte, Maxlengte, SoortValidatie);
		if (!checker.isEmpty()) {
			try {
				WebElement elem = invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver);
				// Null indicates: expected tooltip text balloon is missing
				if (elem == null) {
					TooltipResult.add("Tooltip ontbreekt voor element " + Naamobject);
					System.out.println("Tooltip ontbreekt voor element:" + Naamobject);
					...
					if (checker.contains("BSN")) {
						if (!invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers")) {
							TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[11 Proef] Dit veld voldoet niet aan de 11 proef of bevat geen 9 cijfers \r\n");
						}
					}
					else {
						if (checker.contains("Te lang")) {
							if (!invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" + invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Aantal karakters] Dit veld mag maximaal " + Maxlengte + " karakters bevatten \r\n");
							}
						...
						if (checker.contains("Geen positief getal")) {
							if (!invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[Getal] Dit veld mag alleen positieve gehele getallen bevatten.")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Getal] Dit veld mag alleen positieve gehele getallen bevatten.\" \r\n ");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Getal] Dit veld mag alleen positieve gehele getallen bevatten. \r\n ");
						...
						if (checker.contains("Te Kort")) {
							if (!invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver).getText().contains("[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: \"[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(WinstenVerliesRekeningTooltipObjecten.class, Naamobject, driver).getText());
								System.out.println("verwacht:[Aantal karakters] Dit veld moet minimaal " + Minlengte + " karakters bevatten \r\n");
			...
			try {
				...
				if (elem == null) {
					...
					if (checker.contains("BSN")) {
						...
						if (checker.contains("Positief6")) {
							if (!invoke(AlgemeneGegevensTooltipObjects.class, Naamobject, driver).getText().contains("Dit veld moet een positief getal bevatten tussen 0 en 999.999. Formaat is xxxxxx")) {
								TooltipResult.add("Tooltip " + Naamobject + " onjuist: verwachte text was: Dit veld moet een positief getal bevatten tussen 0 en 999.999. Formaat is xxxxxx\" \r\n");
								System.out.println(Naamobject);
								System.out.println("gelezen:" +invoke(AlgemeneGegevensTooltipObjects.class, Naamobject, driver).getText());
								System.out.println("verwacht:Dit veld moet een positief getal bevatten tussen 0 en 999.999. Formaat is xxxxxx \r\n");
							}
						}
					}
				}
